...
$objetoCapaNegocio= new capaNegocioPaciente();	
try{
	if($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST)){
		...
		if(isset($_POST['insertar'])){
			$objetoCapaNegocio->insertar($_POST['nombre'],$_POST['apellido'],$_POST['cedula'],$_POST['correo'],$_POST['nit'],$_POST['sexo'],$_POST['telefono']);
		}
...
<body>
	<br>
	<br>
<h1 class="h2 text-center pt-5 mt-4">PACIENTES</h1>
